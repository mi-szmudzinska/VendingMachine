...
button1=Button(window,image=photoone)
button1.grid(row=5,column=6,sticky=N,padx=0,pady=0)

button2=Button(window,image=phototwo)
button2.grid(row=5,column=7,sticky=NE,padx=0,pady=0)

button3=Button(window,image=photothree)
button3.grid(row=5,column=8,sticky=NE,padx=0,pady=0)

button4=Button(window,image=photofour)
button4.grid(row=6,column=6,sticky=NE,padx=0,pady=0)

button5=Button(window,image=photofive)
button5.grid(row=6,column=7,sticky=NE,padx=0,pady=0)

button6=Button(window,image=photosix)
button6.grid(row=6,column=8,sticky=NE,padx=0,pady=0)

button7=Button(window,image=photoseven)
button7.grid(row=6,column=6,sticky=NE,padx=0,pady=38)

button8=Button(window,image=photoeight)
button8.grid(row=6,column=7,sticky=NE,padx=0,pady=38)

button9=Button(window,image=photonine)
button9.grid(row=6,column=8,sticky=NE,padx=0,pady=38)
